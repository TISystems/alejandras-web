...
export class ManicureService {
  ...
  {
    nombre: "Permanente/Cristales",
    descripcion: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    img: "assets/img/servicios/Manicure-pedicure/permanente-cristales/cristales.jpeg",
  },
  {
    nombre: "Stamping",
  ...
  {
    nombre: "Rusa",
    descripcion: "Se realiza con un torno dejando la zona de la cutícula y la piel alrededor de la uña perfectamente lisa, esto permite realizar el esmaltado “bajo cutícula” o muy cerca a la cutícula.",
