...
@Component({
  selector: 'app-quiero-alisado',
  templateUrl: './quiero-alisado.component.html',
  styleUrls: ['./quiero-alisado.component.css']
})
export class QuieroAlisadoComponent  {
  ...
  constructor(private activatedRoute: ActivatedRoute, private alisadoService: AlisadoService,
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      this.alisado = this.alisadoService.getAlisado(params['id']);
